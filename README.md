...
The visible spreadsheet title is `Gorilla Cars Leads META ADS Form`. The app reads from `Sheet1`, `Sheet2`, `Leads 3`, `Leads 4`, and `Leads 5 (2)` by default and writes lead updates back to the original tab each lead came from.
...
GOOGLE_SHEET_NAMES=Sheet1,Sheet2,Leads 3,Leads 4,Leads 5 (2)
